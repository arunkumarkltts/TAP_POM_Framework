...
public class MediaManagerMyShoppingCartAirlineAircraftsPage extends TapWrappers{

	public MediaManagerMyShoppingCartAirlineAircraftsPage(RemoteWebDriver driver, ExtentTest test){
		this.driver = driver;
		this.test = test;
	...
	public MediaManagerMyShoppingCartAirlineAircraftsPage verifyAirlineAircraftsCount(int count){
